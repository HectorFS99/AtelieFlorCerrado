                                            ...
                                            <div class="accordion" id="accordionEnderecosOpcoes">
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="collapseCadastrarEndereco" class="accordion-collapse collapse" data-bs-parent="#accordionEnderecosOpcoes">
                                                        <!-- Formulário -->
                                                        <form id="frmCadastrarEndereco" method="post" name="frmCadastrarEndereco" class="formulario m-3"  onsubmit="confirmarFormulario(event, 'frmCadastrarEndereco', 'acoes/endereco/cadastrar_endereco.php');">
                                                            <!-- Nome do Endereço -->                                   
                                    ...
                                    <div class="accordion" id="accordionCartoesPagamentoOpcoes">
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseCadastrarCartaoPagamento" class="accordion-collapse collapse" data-bs-parent="#accordionCartoesPagamentoOpcoes">
                                                <!-- Formulário -->
                                                <form id="frmCadastrarCartaoPagamento" name="frmCadastrarCartaoPagamento" class="formulario m-3" method="post" onsubmit="confirmarFormulario(event, 'frmCadastrarCartaoPagamento', 'acoes/pagamento/cadastrar_cartao.php');">
                                                    <!-- Apelido -->
                                                    <div class="form-floating">
