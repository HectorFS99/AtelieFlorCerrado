...
<header>
    <nav class="navbar">
        ...
        <a href="carrinho.php" class="btn btn-contorno">
            ...
            <?php if ($qtd_carr != null) {
                echo "<span id=\"contador-obj\">$qtd_carr</span>";
            } ?>
        </a>

        <button id="btnHamburguer" class="btn-menu-hamburguer" onclick="menuHamburguer();">
            <i class="fa-solid fa-bars"></i>
        </button>

        <div id="menu-superior" class="btns_barra_superior">
        ...
        <a href="favoritos.php" class="btn btn-contorno">
            ...
            <?php if ($qtd_fav != null) {
                echo "<span id=\"contador-obj\">$qtd_fav</span>";
            } ?>
        </a>
