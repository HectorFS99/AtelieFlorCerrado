    ...
    <body>
        ...
        <?php 
            if (isset($_GET['id_produto'])) {
                ...
                if ($avaliacao = mysql_fetch_assoc($resultado2)) { } else {
        ...
        <main class="main-detalhes">
            <div class="detalhes">
                ...
                <div class="detalhes-conteudo">
                    <a href="pagina-inicial.php" class="btn btn-sm btn-cor-principal mb-2"><b><i class="fa-solid fa-arrow-left"></i> Voltar</b></a>
                    <h3><?php echo $produto['nome']; ?></h3>
                        ...
                        <div class="detalhes-conteudo_botoes" id="grpBtnAcoes">
                            ...
                            <a href="./acoes/carrinho/adicionar_produto.php?id_produto=<?= $id_produto ?>" class="btn btn-lg btn-cor-principal"><strong><i class="fa-solid fa-cart-plus"></i> ADICIONAR AO CARRINHO</strong></a>
                        </div>
                        ...
                        <div class="frete">
                            ...
                            <div class="frete-input">
                                <div class="input-group" style="max-width: 250px;">
                                    ...
                                    <button onclick="pesquisaCep('txtCep');" class="btn btn-cor-principal"><i class="fa-solid fa-magnifying-glass"></i></button>
                                </div>
            ...
            <div class="detalhes">
                <div class="detalhes-dimensoes">
                    <h3 class=""><i class="bi bi-bounding-box-circles"></i> Dimensões</h3>
                    <div class="detalhes-dimensoes_valores">
                        <div><i class="fa-solid fa-up-down"></i> Altura: <?php echo $produto['altura']; ?></div>
                        <div><i class="bi bi-box-fill"></i> Profundidade: <?php echo $produto['profundidade']; ?></div>
                        <div><i class="fa-solid fa-left-right"></i> Largura: <?php echo $produto['largura']; ?></div>
                        <div><i class="fa-solid fa-weight-hanging"></i> Peso: <?php echo $produto['peso']; ?></div>
                    </div>
                </div>
                <div class="detalhes-descricao">
                    <h3><i class="bi bi-justify-left"></i> Descrição</h3>
