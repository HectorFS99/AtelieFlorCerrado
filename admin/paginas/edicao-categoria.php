        ...
        <?php 
            ...
            if (isset($_POST['salvar'])) {
                ...
                if (mysql_query($sql_update, $conecta_db)) {
                    echo "<script>alert('Categoria atualizada com sucesso!'); window.location.href = 'categorias.php';</script>";
                } else {
        ...
        <main class="conteudo-principal">
            ...
            <form action="edicao-categoria.php" method="POST" name="frmCategoria" class="formulario w-100">
                ...
                <div class="form-botoes">
                    <button type="button" onclick="window.location.href='categorias.php'" class="botao form-btn btn-cancelar">Cancelar</button>
